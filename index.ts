...
import { Vector3, StandardMaterial, Color3, PointLight, Texture, Space, Axis, Color4, UniversalCamera, FreeCamera } from '@babylonjs/core'
...
skyboxMaterial.disableLighting = true;
  ...
  camera.setPosition(new Vector3(100,20,-100));
...
sun.position = new Vector3(0, 0, 0);
  ...
  light0.diffuse = new Color3(0, 1, 1);
